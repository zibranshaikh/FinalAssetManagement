...
<tr><td>Designation</td><td> <select  id="empDes" name="designation"  required="required">
 ...
 <%if(!cc.getDesignation().equalsIgnoreCase("Employee"))
     {
  %>                  <tr id="Employee"><td>
<b>EMPLOYEE ID</b>          </td><td><input type="text" name="eid1" id="eid" placeholder="E101" value="E100" maxlength="15" required="required" />
                     </td></tr>
                     <tr id="Manager"><td>
<b>Manager ID</b>           </td><td><select name="mid1" id="mid" />
 ...
 <%if(!cc.getDesignation().equalsIgnoreCase("Manager"))
  ...
  %> 
                     <tr id="ManagerId"><td>
<b>Manager ID</b>           </td><td><input type="text" name="mid2" id="mid" value="M100" placeholder="M101" maxlength="15" required="required" />
                     </td></tr>
                     <tr id="SupportId"><td>
...
<%if(!cc.getDesignation().equalsIgnoreCase("Support Team"))
  ...
  %> 
                     <tr id="Support"><td>
<b>EMPLOYEE ID</b>          </td><td><input type="text" name="eid2" id="eid" value="S100" placeholder="S101" maxlength="15" required="required" />
                   </td></tr>
<%}%> 
